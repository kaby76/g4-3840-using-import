...
/// </summary>
public abstract class HTMLLexerBase : Lexer
{
    /// <summary>
    ...
    public HTMLLexerBase(ICharStream input)
        : base(input)
    {
    }

    public HTMLLexerBase(ICharStream input, TextWriter output, TextWriter errorOutput) : this(input)
    {
    }
    ...
    {
        if (_lastToken == null || _lastToken.Type == HTMLLexer.OpenBrace)
        {
    ...
    protected bool IsRegexPossible()
    {
        ...
        switch (_lastToken.Type)
        {
            ...
            case HTMLLexer.NullLiteral:
            case HTMLLexer.BooleanLiteral:
            case HTMLLexer.This:
            case HTMLLexer.CloseBracket:
            case HTMLLexer.CloseParen:
            case HTMLLexer.OctalIntegerLiteral:
            case HTMLLexer.DecimalLiteral:
            case HTMLLexer.HexIntegerLiteral:
            case HTMLLexer.StringLiteral:
            case HTMLLexer.PlusPlus:
            case HTMLLexer.MinusMinus:
